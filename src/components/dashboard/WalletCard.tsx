  ...
  return <Card className="overflow-hidden rounded-3xl border-0 shadow-lg relative">
      <div className="bg-[#EB611A] p-6 text-white relative overflow-hidden">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          <Button variant="ghost" size="icon" className="h-10 w-10 text-white hover:bg-white/10 rounded-full" onClick={() => setShowBalance(!showBalance)}>
            {showBalance ? <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <CardContent className="p-0">
        {!showHistory ? <div className="bg-white dark:bg-black/40 rounded-t-3xl -mt-3 overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <Button variant="ghost" size="sm" onClick={() => setShowHistory(false)} className="text-[#EB611A]">
                Back
              </Button>
            </div>
