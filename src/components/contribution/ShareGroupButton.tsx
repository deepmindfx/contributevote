...
export function ShareGroupButton({ groupId, groupName, groupDescription }: ShareGroupButtonProps) {
  const [open, setOpen] = useState(false);
  const [copied, setCopied] = useState(false);

  const shareLink = GroupJoinService.generateShareLink(groupId);
  const shareText = GroupJoinService.generateShareText(groupName, groupDescription, shareLink);
